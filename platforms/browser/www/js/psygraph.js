...
var PGEN = {
    ...
    synchronize: function (quick, callback) {
        ...
        callback = (typeof(callback)=="undefined") ? (function fx(){}) : callback;
        // update accel and location state
        ...
        function uploadCreatedEvents(callback) {
            ...
            for(var i=0; i<pg.events.length; i+=nEvents) {
                ...
                if(newE.length) {
                    ...
                    postData({action: "setEventArray", data: toSet},
    ...
    generateMetaPage: function(page, callback) {
        ...
        function cb() {
            var header = '<a id="'+page+'_leftButton" data-role="button" data-position="fixed" onclick="gotoPage(pg.page(), true); return true;" data-icon="arrow-l" data-iconpos="left" class="ui-btn-left">Back</a>';
            header += '<h2><img class="banner" src="css/images/logo.png">&nbsp;<b id="'+page+'_title">'+page+'</b></h2>';
            header += '<a id="'+page+'_rightButton" data-role="button" data-position="fixed" data-icon="arrow-u" data-iconpos="right" class="ui-btn-right">Forward</a>';
