...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    public void startRecording(String file) {
        ...
        case NONE:
            ...
            this.recorder.setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);//AAC_ADTS
     ...
     *
     * @return                  maximum amplitude of the first channel, or 0 if not playing
     */
    public float getMaxRecordingAmp() {
        if ((this.state == STATE.MEDIA_RUNNING) || (this.state == STATE.MEDIA_PAUSED)) {
            float amp = this.recorder.getMaxAmplitude();
            float max = (float) 32767.0 / 2;//this.recorder.getAudioSourceMax();
            return amp/max;
        }
        else {
            return 0;
