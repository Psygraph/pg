...
/**
 * Get recording power level.
 */
Media.prototype.getRecordingPower = function(success) {
    exec(success, this.errorCallback, "Media", "getRecordingPower", [this.id]);
};
    ...
    if (media) {
        switch(msgType) {
            ...
            case Media.MEDIA_ERROR :
                ...
                break;
            case Media.MEDIA_POWER :
                media._power = Number(value);
                break;
